...
export default async function SchedulePage() {
  ...
  const [{ data: configs }, { data: milestones }] = await Promise.all([
    ...
    supabase
      .from("exam_schedules")
      .select(
        "id, milestone_type, milestone_label, scheduled_date, date_end, extra_dates, date_precision, academic_year, notes, is_confirmed, source_url, exam_configs!inner(name, slug, color, is_active)"
      )
